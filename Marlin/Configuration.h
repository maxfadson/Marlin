...
#define STRING_CONFIG_H_AUTHOR "maxfadson" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 189.32
  #define DEFAULT_bedKi 37.28
  #define DEFAULT_bedKd 641.05
